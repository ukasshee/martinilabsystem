...
export default function Privacy() {
  return <main className="privacy-page"><div className="privacy-shell">
    ...
    <article>
      ...
      <section><h2>6. Kontakt</h2><p>W sprawach związanych z prywatnością napisz na <a href="mailto:biuro@martinilabsystem.pl">biuro@martinilabsystem.pl</a>. Przed publikacją należy potwierdzić poprawność tego adresu oraz uzupełnić dane administratora powyżej.</p></section>
